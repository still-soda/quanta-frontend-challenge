...
// 更新提交数据
watchEffect(() => updateSubmissionData());
async function updateSubmissionData() {
   if (!props.submission || typeof id !== 'string') return;
   ...
   try {
      ...
      challengeId.value = submission.challengeId;
      ...
      percent.value = submission.correctRate;
